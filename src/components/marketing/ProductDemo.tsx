        ...
        <AnimatePresence>
          {step >= 1 && (
            <motion.div
              ...
              className="bg-[#0A9AFF]/10 rounded-lg p-2.5 text-xs text-[#111827] self-end"
            >
          ...
          {step >= 2 && (
            ...
            >
              <Bot className="w-3.5 h-3.5 text-[#0A9AFF] shrink-0 mt-0.5" />
    ...
    <div className="w-full max-w-[360px] space-y-3">
      {cards.map((card, i) => (
        ...
        >
          ...
          <span className="text-xs font-bold text-[#0A9AFF] bg-[#0A9AFF]/10 rounded-full px-2.5 py-1">
            +{card.pts}
          </span>
        </motion.div>
      ))}
      ...
      <motion.div
        ...
        className="bg-[#0A9AFF] rounded-lg p-4 flex items-center justify-between"
      >
        <div>
      ...
      >
        ...
        <Calendar className="w-3.5 h-3.5 text-[#0A9AFF]" />
      </motion.div>
    </div>
  );
}
          ...
          return (
            ...
            >
              ...
              <motion.div
                ...
                className="w-full rounded-t-lg bg-[#0A9AFF]"
                style={{ minHeight: 0 }}
              />
...
function RoutingMockup() {
  ...
  return (
    <div className="w-full max-w-[360px] space-y-3">
      ...
      >
        <div className="bg-[#0A9AFF] text-white rounded-lg px-4 py-2.5 text-xs font-bold flex items-center gap-2">
...
function IntegrationsMockup() {
  ...
  return (
    <div className="w-full max-w-[360px] space-y-5 relative">
      ...
      >
        <div className="bg-[#0A9AFF] text-white text-xs font-bold rounded-lg px-4 py-2">
          MyVSL
        </div>
      </motion.div>
    ...
    <div className="w-full max-w-[380px] space-y-4">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className={`px-3 py-2 rounded-lg text-xs font-medium transition-colors ${step >= 2 ? "bg-[#0A9AFF] text-white" : "bg-[#F3F4F6] text-[#9CA3AF]"}`}>
      ...
      {step >= 2 && (
        ...
        >
          ...
          {step >= 3 && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center gap-1.5 mt-3 text-xs text-[#0A9AFF] font-medium">
      ...
      {step >= 4 && (
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          className="bg-[#0A9AFF]/5 border border-[#0A9AFF]/20 rounded-xl p-4 text-center"
        >
          <div className="flex items-center justify-center gap-2 mb-1">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#0A9AFF] opacity-75" />
              <span className="relative inline-flex rounded-full h-2 w-2 bg-[#0A9AFF]" />
            </span>
            <span className="text-sm font-semibold text-[#0A9AFF]">Live at form.yourbrand.com</span>
          </div>
    ...
    <div className="w-full max-w-[360px] space-y-3">
      ...
      {emails.map((email, i) => (
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <Mail className="w-3.5 h-3.5 text-[#0A9AFF] shrink-0" />
    ...
    <div className="w-full max-w-[340px] relative">
      ...
      >
        ...
        <div className="p-3 text-center">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-[#0A9AFF]/10 mx-auto mb-2 flex items-center justify-center">
              <Zap className="w-4 h-4 text-[#0A9AFF]" />
            </div>
            <div className="text-[9px] font-semibold text-[#0A9AFF] uppercase tracking-wider mb-1">
              Quick Quiz
            </div>
...
export function ProductDemo() {
  ...
  return (
    <section id="features" className="bg-[#FAFAF8] py-20 sm:py-28 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        {/* Section header */}
        <div className="text-center mb-12">
          <h2 className="text-4xl sm:text-5xl font-bold text-[#0A0A0A] tracking-[-0.03em] mb-4" style={{ fontFamily: "var(--font-instrument-sans)" }}>
        ...
        <div className="flex items-center justify-start sm:justify-center mb-10 -mx-4 sm:mx-0 px-4 sm:px-0 overflow-x-auto scrollbar-hide">
          <div className="inline-flex items-center gap-0.5 bg-white/80 backdrop-blur-sm rounded-full p-1.5 ring-1 ring-black/[0.06] shadow-sm">
            {tabs.map((tab) => (
              ...
              >
                <tab.icon className={`w-4 h-4 ${activeTab === tab.id ? "text-[#7CC8FB]" : ""}`} />
