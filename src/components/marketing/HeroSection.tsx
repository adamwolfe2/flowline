    ...
    <section className="relative overflow-hidden pb-24">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 sm:px-6 pt-20 sm:pt-28 md:pt-36 max-w-4xl mx-auto">
        ...
        <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
          ...
          className="text-white/80 max-w-2xl mt-5 mb-8 sm:mb-10"
          style={{ fontFamily: "var(--font-plus-jakarta)", textShadow: "0 1px 10px rgba(0,0,0,0.08)" }}>
          <span className="block text-sm sm:text-xl md:text-2xl leading-relaxed mb-2">Describe what you need and let AI handle the rest.</span>
          <span className="block text-sm sm:text-lg md:text-xl leading-relaxed">Build{" "}
          <span className="group/pill inline-flex items-center gap-1 sm:gap-1.5 bg-white/20 backdrop-blur-sm text-white font-semibold px-2 sm:px-3 py-0.5 sm:py-1 rounded-lg text-xs sm:text-sm cursor-default transition-all duration-200 hover:bg-white/30 hover:scale-105 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-white/10">
            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 transition-transform duration-200 group-hover/pill:scale-125 group-hover/pill:rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            Quiz Funnels
          </span>
          {", "}
          <span className="group/pill inline-flex items-center gap-1 sm:gap-1.5 bg-white/20 backdrop-blur-sm text-white font-semibold px-2 sm:px-3 py-0.5 sm:py-1 rounded-lg text-xs sm:text-sm cursor-default transition-all duration-200 hover:bg-white/30 hover:scale-105 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-white/10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-white/20">
            <textarea
              ...
              rows={3}
              className="w-full px-4 sm:px-6 py-4 sm:py-5 text-base text-[#111827] placeholder-[#9CA3AF] bg-transparent resize-none outline-none border-none focus:ring-0 focus:outline-none"
              style={{ fontSize: "16px" }}
            ...
            <div className="flex items-center justify-between px-3 sm:px-5 pb-4">
              {/* Integration logos */}
                  ...
                  <AnimatePresence>
                    {showTemplates && (
                      <motion.div
                        ...
                        className="absolute bottom-full right-0 mb-2 w-56 sm:w-64 bg-white rounded-xl shadow-lg border border-[#E5E7EB] overflow-hidden z-50"
                      >
