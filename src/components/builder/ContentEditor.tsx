  ...
  return (
    <div className="border border-[#E5E7EB] rounded-lg overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between p-3 bg-[#F9FAFB] hover:bg-[#F3F4F6] transition-colors"
      >
...
export function ContentEditor({ config, onSave }: ContentEditorProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      <Section title="Welcome Page" defaultOpen={false}>
        <div>
        ...
        <div id="editor-trust-badges">
          ...
          <p className="text-[10px] text-gray-400 mb-2">
            Three short phrases shown below the CTA button.
          </p>
      ...
      <Section title="Quiz Questions" defaultOpen={true}>
            ...
            {config.quiz.questions.map((q: QuizQuestion, qi: number) => (
              <div key={q.key} className="border border-gray-100 rounded-lg overflow-hidden">
                <div className="flex items-center p-3 hover:bg-gray-50 transition-colors">
                  ...
                  <button
                    onClick={() => setExpandedQ(expandedQ === qi ? null : qi)}
                    aria-label={expandedQ === qi ? "Collapse question" : "Expand question"}
                  >
                    {expandedQ === qi ? (
                      ...
                      {q.options.map((opt, oi) => (
                        <div key={opt.id} className="flex items-center gap-1.5">
                          ...
                          <Input
                            ...
                            value={opt.points}
                            onChange={(e) =>
                              updateOption(qi, oi, "points", parseInt(e.target.value) || 0)
                            }
      ...
      <Section title="Score Thresholds" defaultOpen={false}>
        <div>
          ...
          {config.quiz.thresholds.high < config.quiz.thresholds.mid && (
            <p className="text-xs text-red-500 mt-1.5">
              High threshold must be greater than or equal to mid threshold.
            </p>
          )}
        </div>
      </Section>
      ...
      {/* Email Step Section */}
      <Section title="Email Step" defaultOpen={false}>
        <div>
      ...
      <Section title="Success Page" defaultOpen={false}>
        <div>
        ...
        <div>
          ...
          />
          <p className="text-[10px] text-gray-300 mt-1">
            Redirect leads to this URL after submission instead of showing the success page. Leave
            blank to show the default success page.
          </p>
        </div>
      </Section>

      {/* Personalized Results Section */}
      <Section title="Personalized Results" defaultOpen={false}>
        <p className="text-[11px] text-gray-400 mb-2">
          Show different messages based on lead score tier. Leave blank to use the default success
          text above.
        </p>
        ...
        <div className="space-y-4">
          <div className="p-3 bg-emerald-50 rounded-lg border border-emerald-100">
            <div className="flex items-center gap-2 mb-2">
              ...
              <Label className="text-[11px] text-emerald-700 font-medium">
                High Score Result
              </Label>
            </div>
            <Input
