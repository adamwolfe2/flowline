...
export function InsightsCard({ funnelId, timeRange, userPlan, isAdmin }: InsightsCardProps) {
  ...
  if (state.kind === "plan_gated") {
    return (
      <div className="bg-white rounded-[16px] ring-1 ring-black/[0.06] p-6 flex flex-col items-center text-center gap-3">
  ...
  if (state.kind === "loading") {
    return (
      <div className="bg-white rounded-[16px] ring-1 ring-black/[0.06] p-6 space-y-4">
  ...
  if (state.kind === "insufficient_data") {
    return (
      <div className="bg-white rounded-[16px] ring-1 ring-black/[0.06] p-6 flex flex-col gap-3">
        <div className="flex items-center gap-2">
  ...
  if (state.kind === "error") {
    return (
      <div className="bg-white rounded-[16px] ring-1 ring-black/[0.06] p-6 flex items-center justify-between gap-4">
        <div className="flex items-center gap-2">
  ...
  return (
    <div className="bg-white rounded-[16px] ring-1 ring-black/[0.06] p-4 sm:p-6 space-y-5">
      {/* Header */}
