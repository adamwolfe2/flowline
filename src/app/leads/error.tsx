...
export default function LeadsError({ reset }: { reset: () => void }) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6">
      <h2 className="text-xl font-semibold text-[#111827] mb-2">Failed to load leads</h2>
      <p className="text-sm text-[#6B7280] mb-6">Something went wrong loading your leads data.</p>
      <button
        onClick={reset}
